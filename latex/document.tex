...
\hypersetup{pdfauthor={Bc. et Bc. Jaroslav Svoboda,Jaime Sancho,Diallo Elhadj Sadou}, pdfkeywords={smart,lighting}}
...
\end{figure}
\begin{figure}[!ht]
	\caption{Example of use of protocol}
	\label{fig:exprotocol}

	\centering
	\includegraphics[width=0.98\textwidth]{img/examProt.eps}
\end{figure}
...
\end{figure}
\begin{figure}[!ht]
	\caption{Base station with light intensity sensor}
	\label{fig:basestation2}

	\centering
	\includegraphics[width=0.98\textwidth]{img/BaseStation2.eps}
\end{figure}
...
\end{figure}
\chapter{Testing}
In order to test the project, in first place the Java Solarium Emulator was used. Once the project was working well, it was tested on the real motes using the graphical interface. For doing that, three motes has been used: one for the light sensor, other for the movement sensor and another one for the aggregating. Furthermore, the base station was used. The following tests were done in order to verify the functioning of the project (the MAC address selector shows the MAC of the motes in Solarium, the first corresponds with the light mote and the second with the movement mote):
\begin{figure}[!ht]
	\caption{Motes used}
	\label{fig:motes}

	\centering
	\includegraphics[width=0.88\textwidth]{{"./img/motes"}.jpg}
\end{figure}
\begin{figure}[!ht]
	...
	\centering
	\includegraphics[width=0.88\textwidth]{{"./img/graphInter"}.png}
\end{figure}
\begin{figure}[!ht]
	\caption{Light information of the light sensor and threshold defined}
	\label{fig:light}

	\centering
	\includegraphics[width=0.98\textwidth]{{"./img/lightinfo"}.png}
\end{figure}
\begin{figure}[!ht]
	\caption{With the mode in Manual, it is possible to turn on/off the selected mote with the button
		ON/OFF}
	\label{fig:manual}

	\centering
	\includegraphics[width=0.98\textwidth]{{"./img/manual"}.png}
\end{figure}
\begin{figure}[!ht]
	\caption{}
	\label{fig:mote}
	...
	\centering
	\includegraphics[width=0.98\textwidth]{{"./img/mote"}.jpg}
\end{figure}
\begin{figure}[!ht]
	\caption{If the mode is set again to Automatic, it is possible to see the change of the light status whenever the switch (simulating a movement sensor) is pressed. The information registered includes the MAC of the mote, and the time.}
	\label{fig:1}

	\centering
	\includegraphics[width=0.98\textwidth]{{"./img/1"}.png}
\end{figure}
\begin{figure}[!ht]
	\caption{}
	\label{fig:2}
...
\begin{figure}[!ht]
	...
	\centering
	\includegraphics[width=0.98\textwidth]{{"./img/last"}.jpg}
\end{figure}
\chapter{Conclusion}
